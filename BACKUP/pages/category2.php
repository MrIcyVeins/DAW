...
// RSS Feed URL for BBC Science & Tech
...
<div class="container mt-5">
    <!-- Page Title -->
    <div class="container mt-5" style="position: relative; height: 300px; background: url('/assets/science-tech.png') no-repeat center center; background-size: cover; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.3);">
    ...
    <p class="text-center" style="font-style: italic;">Discover the latest in science and technology from trusted sources.</p>
            ...
            <?php foreach (array_slice($articles, 0, 3) as $article): ?>
                <div class="col-md-4 mb-4">
                    <div class="newspaper-article p-3" style="border: 1px solid #ccc; background: #fff;">
                        ...
                        <a href="<?= htmlspecialchars($article['link']) ?>" target="_blank" style="text-decoration: underline; color: #000;">
                            Read full article
                        </a>
                    </div>
                </div>
